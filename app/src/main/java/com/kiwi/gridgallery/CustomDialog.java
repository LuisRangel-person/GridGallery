...
public class CustomDialog {//This is a class to deliver a message to the user

    public CustomDialog(Activity act, String title, String message, Boolean showPos, Boolean showNeg){
